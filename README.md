...
**209 tools across 19 on-demand toolsets.** Schematic capture, PCB layout and
...
**Context economy is a feature.** Exposing all 209 tools to an LLM costs roughly 23K
