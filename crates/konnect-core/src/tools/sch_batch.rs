        ...
        tool!(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "edits": {
                        "type": "array",
                        "description": "List of {reference, reference_visible?, value_visible?} edit objects",
                        "items": {
                            "type": "object",
                            "properties": {
                                "reference": { "type": "string" },
...
fn field_visibility_conflict_result(path: &Path) -> CallToolResult {
    CallToolResult::error_kind(
...
fn persist_field_visibility_update(
    ...
    match write_atomic_if_unchanged(path, expected, replacement) {
        ...
        Err(SexpError::Conflict { .. }) => field_visibility_conflict_result(path),
...
mod field_visibility_tests {
    ...
    #[tokio::test]
    async fn malformed_requests_and_malformed_hide_are_rejected_without_writes() {
        for (name, content, args) in [
            (
                "visibility-duplicate-ref.kicad_sch",
                SCH_VISIBLE_REF_HIDDEN_VALUE,
                json!({
                    "edits": [
            ...
            (
                "visibility-unknown-key.kicad_sch",
                SCH_VISIBLE_REF_HIDDEN_VALUE,
                json!({
                    "edits": [{"reference": "R1", "reference_visible": false, "unexpected": 1}]
                }),
            ),
            (
                "visibility-non-bool.kicad_sch",
                SCH_VISIBLE_REF_HIDDEN_VALUE,
                json!({
                    "edits": [{"reference": "R1", "reference_visible": "false"}]
                }),
            ),
            (
                "visibility-no-flag.kicad_sch",
                SCH_VISIBLE_REF_HIDDEN_VALUE,
                json!({
                    "edits": [{"reference": "R1"}]
                }),
            ...
            (
                "visibility-malformed-hide.kicad_sch",
                SCH_MALFORMED_HIDE,
                json!({
                    "edits": [{"reference": "R1", "reference_visible": true}]
                }),
