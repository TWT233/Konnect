...
pub static ALL_TOOLSETS: &[ToolsetMeta] = &[
    ...
    ToolsetMeta {
        name: "pcb_components",
        description: "Place, move, rotate, flip, atomically batch-pose, align and duplicate PCB footprints; inspect pads; inspect and edit a placed footprint's graphics",
        category: "pcb",
        tool_count: 17,
    },
    ToolsetMeta {
